...
class CreditOrganizationAdmin(admin.ModelAdmin):
    list_display = ('name', 'phone') #Сортировка отображения на странице
    search_fields = ['name', 'phone'] #Текстовый поиск


class ProposalAdmin(admin.ModelAdmin):
    list_display = ('date_of_creation', 'date_of_change', 'name', 'type_of_a_proposal', 'start_date_of_rotation',
                    'end_date_of_rotation', 'min_scoring_ball', 'max_scoring_ball', 'credit_organization') #Сортировка отображения на странице
...
class BidAdmin(admin.ModelAdmin):
    list_display = ('date_of_creation', 'form', 'proposal', 'status', 'date_of_dispatch') #Сортировка отображения на странице
    date_hierarchy = 'date_of_creation' #Иерархический фильтр по дате создания
